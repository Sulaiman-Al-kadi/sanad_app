...
class ManagerCompleteRequestPage extends StatefulWidget {
  ...
  const ManagerCompleteRequestPage(
      {required this.requestId, required this.userId, Key? key})
      : super(key: key);

  @override
  _ManagerCompleteRequestPageState createState() =>
      _ManagerCompleteRequestPageState();
}

class _ManagerCompleteRequestPageState
    extends State<ManagerCompleteRequestPage> {
